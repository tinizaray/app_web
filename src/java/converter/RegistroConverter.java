...
public class RegistroConverter implements Converter {
    ...
    Persistencia.RegistroPK getKey(String value) {
        Persistencia.RegistroPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new Persistencia.RegistroPK();
    ...
    String getStringKey(Persistencia.RegistroPK value) {
