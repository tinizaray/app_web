...
@FacesConverter(value = "alumnosConverter")
public class AlumnosConverter implements Converter {
    ...
    private AlumnosFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(AlumnosFacade.class).get();
