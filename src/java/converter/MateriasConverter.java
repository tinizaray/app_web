...
@FacesConverter(value = "materiasConverter")
public class MateriasConverter implements Converter {

    private MateriasFacade ejbFacade;
    ...
    private MateriasFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(MateriasFacade.class).get();
